...
// POST /tickets - creates a new ticket in MYSQL and autimatically logs action to mongoDb
...
// post/ticket-notes - add a note to t ticket in mongodb

app.post ('/ticket-notes', async (req,res)=>{
    const {
        ticket_id, note, added_by
    } = req.body
...
// post /login - validates the credentials and returns user informatoin with role
